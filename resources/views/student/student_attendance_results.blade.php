        ...
        <div class="content">
            <div class="function-attendance">
                ...
                <div id="hk1_2024" class="semester-content" style="display: block;">
                    ...
                    <!--
                    <div class="subject active" data-index="0">
                        <p>Hệ nhúng N08</p>
                    </div>
-->
                    @foreach ($courses as $course)

                    <div class="subject" data-index="{{ $loop->iteration }}">
                ...
                <div id="hk2_2024" class="semester-content" style="display: none;">
                    <p>Danh sách lớp học:</p>
                    <div class="subject" data-index="0">
                        <p>Lập trình C nâng cao</p>
                    </div>
                    <div class="subject" data-index="1">
                        <p>Giải tích</p>
                    </div>
                    <div class="subject" data-index="2">
                        <p>Toán rời rạc</p>
                    </div>
                    <div class="subject" data-index="3">
                        <p>Xác suất thống kê</p>
                    </div>
                    <div class="subject" data-index="4">
                        <p>Vật lý cho CNTT</p>
                    </div>
                </div>
                ...
                <div id="hk2_2023" class="semester-content" style="display: none;">
                    ...
                    <div class="subject" data-index="1">
                        <p>Phân tích và thiết kế phần mềm</p>
                    </div>
                    <div class="subject" data-index="2">
                        <p>Trực quan hóa dữ liệu</p>
                    </div>
                    <div class="subject" data-index="3">
                        <p>Quản trị dự án CNTT</p>
                    </div>
                    <div class="subject" data-index="4">
                        <p>Thiết kế web nâng cao</p>
                    </div>
                </div>
                <div id="hk1_2022" class="semester-content" style="display: none;">
                    <p>Danh sách lớp học:</p>
                    <div class="subject" data-index="0">
                        <p>Ứng dụng phân tán</p>
                    </div>
                    <div class="subject" data-index="1">
                        <p>Phân tích và thiết kế phần mềm</p>
                    </div>
                    <div class="subject" data-index="2">
                        <p>Lập trinh song song</p>
                    </div>
                    <div class="subject" data-index="3">
                        <p>Thuật toán ứng dụn</p>
                    </div>
                    <div class="subject" data-index="4">
                        <p>Tiếng Anh 2</p>
                    </div>
